...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $mensaje = $_POST['mensaje'];
        //insertar en la BD
        $query = "INSERT INTO informacion (nombre, email, telefono, mensaje) VALUES ( '$name', '$email', '$telefono' , '$mensaje')";
        $resultado = mysqli_query($db, $query);
    ...
    <article class="modal" id="contacto">
        <div class="modal-contenido">
            ...
            <article class="formulario-modal">
                <form action="anuncios.php" method="POST" class="form">
                    <div class="forma">
                        <div class="grupo">
                        ...
                        <div class="grupo">
                            ...
                            <br>
                            <textarea name="mensaje" id="" cols="30" rows="5">Hola, me interesa este inmueble que vi en BienesRaicesTux y quiero que me contacten. Gracias.</textarea>
                        </div>
