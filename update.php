    ...
    $nameUser = $propiedad['vendedores_IdVendedores'];
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($errores)) {
            ...
            if ($resultado) {
                ...
                echo "<script language=\"javascript\">window.location.href=\"admin.php?resultado=2\";</script>";
            }
        }
    }
